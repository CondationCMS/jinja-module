...
public class JinjaLifecycleExtension extends ModuleLifeCycleExtension<CMSModuleContext, CMSRequestContext> {

	static JinjaTemplateEngine templateEngine;
	...
	public void activate() {
		templateEngine = new JinjaTemplateEngine(
